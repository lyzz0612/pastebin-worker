...
export function getDocPage(path: string, env: Env, requestUrl?: URL): string | null {
  // 使用请求的 origin 作为基础 URL，如果没有则使用 DEPLOY_URL
  const baseUrl = requestUrl?.origin || env.DEPLOY_URL || ""
